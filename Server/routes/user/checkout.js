...
router.post("/user/create_order", optionalUserAuth, checkout.create_order);
router.post("/payment/webhook", checkout.web_hook);
router.post("/user/payment/webhook", checkout.web_hook);
router.post("/api/payment/webhook", checkout.web_hook);
router.post("/user/get_payment_status", checkout.verify_payment);
router.post("/user/cancel_order", optionalUserAuth, checkout.cancel_order);
